...
class BookingRepositoryTest {
    ...
    void init() {
        ...
        booking3 = Booking.builder()
                          .item(item1)
                          .start(LocalDateTime.now().plus(3, ChronoUnit.DAYS).truncatedTo(ChronoUnit.SECONDS))
                          .end(LocalDateTime.now().plus(4, ChronoUnit.DAYS).truncatedTo(ChronoUnit.SECONDS))
                          .status(BookingStatus.APPROVED)
                          .booker(user2)
                          .build();
