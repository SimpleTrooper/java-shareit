...
public class ItemController {
    ...
    public ItemDto getById(@PathVariable Long itemId) {
        ...
        ItemDto returnedItem = itemService.getById(itemId);
        if (returnedItem != null) {
     ...
     */
    @GetMapping
    public List<ItemDto> getAllByOwnerId(@RequestHeader(name = "X-Sharer-User-Id") Long ownerId) {
        log.info("Request to get all items by ownerId={}", ownerId);
        List<ItemDto> items = itemService.getAllByOwnerId(ownerId);
    ...
    public List<ItemDto> searchBy(@RequestParam String text) {
        ...
        log.info("Successfully get all available items by text={}", text);
        return items;
    }
}
